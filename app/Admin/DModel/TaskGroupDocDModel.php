...
class TaskGroupDocDModel extends DModel {
   ...
   /**
    ...
    protected function resolveArray(&$result) {
        ...
        $result["userFullName"] = $this->getFullName($result["userId"]);
        $result["lastUserFullName"] = $this->getFullName($result["lastUserId"]);
    ...
    public function newEntity() {
        return new \Admin\Entity\TaskGroupDoc();
    }
